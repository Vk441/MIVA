...
export default async function CareersPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-background text-foreground">
      {/* Hero */}
      <section className="relative pt-24 h-[320px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto space-y-2.5 pt-4">
          <span className="text-[10px] font-bold uppercase tracking-widest bg-primary/10 text-primary border border-primary/15 px-3.5 py-1.5 rounded-full inline-block">
            Join the Mission
          </span>
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold uppercase tracking-wide text-primary pt-1 leading-tight">
            Invent the future of flight
          </h1>
          <p className="text-xs md:text-sm text-muted-foreground font-light max-w-xl mx-auto pt-1 leading-relaxed">
